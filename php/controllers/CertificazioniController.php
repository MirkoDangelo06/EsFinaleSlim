...
class CertificazioniController
{
    ...
    public function create(Request $request, Response $response, $args) {
        ...
        $mysqli_connection = new MySQLi('my_mariadb', 'root', 'ciccio', 'scuola');
        $creation = $mysqli_connection->query("INSERT INTO certificazioni (alunno_id, titolo, votazione, ente) VALUES ('$alunno_id', '$titolo', '$votazione', '$ente')");
    ...
    public function update(Request $request, Response $response, $args) {
        ...
        $mysqli_connection = new MySQLi('my_mariadb', 'root', 'ciccio', 'scuola');
        $update = $mysqli_connection->query("UPDATE certificazioni SET alunno_id='$alunno_id', titolo='$titolo', votazione='$votazione', ente='$ente' WHERE id = $args[id]");
